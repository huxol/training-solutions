...
public class BankTest {
    ...
    public void createAccountList() {
        ...
        accounts.add(new Account("acc1",initialBalance, 0));
        accounts.add(new Account("acc2", initialBalance, 0));
        accounts.add(new Account("acc3", initialBalance, 0));
        accounts.add(new Account("acc4", initialBalance, 0));
